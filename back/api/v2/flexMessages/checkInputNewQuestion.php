...
function requestAnswerFlexMessageBuilder($QuestionText){
  ...
  ####### Footer要素 ################
  // ボタンを押した際のアクションを設定
  $sendAction = new MessageTemplateActionBuilder('質問を先生に送る', "質問を送信");
...
function sentQuestionFlexMessage($index){
  ...
  ####### Footer要素 ##############
  $actionUrl = 'https://liff.line.me/1660896972-Xol6KpBr/qanda?index='.$index;
...
function othersQuestionsFlexMessage($Questions){
  ...
  foreach($Questions as $index => $Question){
    ...
    ####### Footer要素 ##############
    // ボタンを押した際のアクションを設定
    $actionUrl = 'https://liff.line.me/1656210261-2116WaLZ/qanda?index='.$index;
  ...
  ####### Footer要素 ##############
  $actionUrl = 'https://liff.line.me/1656210261-2116WaLZ/questions/';
...
function QandAFlexMessage($QuestionIndex, $QuestionText, $AnswerText){
  ...
  ####### Footer要素 ##############
  // 「求める回答ではない」ボタンの設置
  $viewDetailAction =  new UriTemplateActionBuilder('詳しく見る', 'https://liff.line.me/1656210261-2116WaLZ/qanda?index='.$QuestionIndex);
...
function QandAFlexContainer($QuestionId, $QuestionText, $AnswerText){
  ...
  $qandaUrl = 'https://liff.line.me/1656210261-2116WaLZ/qanda?index='.$QuestionId;
  // urlリンクをボタンで表示
...
function ChatFlexContainer($QuestionId, $ChatText){
  ...
  ####### Footer要素 ##############
  $actionUrl = 'https://liff.line.me/1656210261-2116WaLZ/qanda?index='.$QuestionId;
  // urlリンクをボタンで表示
...
function FollowFlexMessageBuilder(){
  ...
  ####### Footer要素 ##############
  $actionUrl = 'https://liff.line.me/1656210261-2116WaLZ/initialsetting/';
...
function askEvaluationFlexMessageBuilder(){
  ...
  ####### Footer要素 ##############
  $actionUrl = 'https://www2.yoslab.net/~suzuki/susan/susan_liff/evaluateform';
